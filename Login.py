...
"}")
        ...
        self.login_bar = QtWidgets.QFrame(self.content)
        self.login_bar.setMaximumSize(QtCore.QSize(450, 550))
        self.login_bar.setStyleSheet("background-color: rgb(20, 20, 20);\n"
"border-radius: 10px")
        self.login_bar.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.login_bar.setFrameShadow(QtWidgets.QFrame.Raised)
        self.login_bar.setObjectName("login_bar")
        self.logo = QtWidgets.QFrame(self.login_bar)
        self.logo.setGeometry(QtCore.QRect(45, 40, 360, 81))
...
"")
        ...
        self.avatar = QtWidgets.QFrame(self.login_bar)
...
"}")
        ...
        self.lineEdit_user = QtWidgets.QLineEdit(self.login_bar)
        self.lineEdit_user.setGeometry(QtCore.QRect(85, 310, 280, 50))
        font = QtGui.QFont()
...
"}")
        ...
        self.lineEdit_password.setGeometry(QtCore.QRect(85, 363, 280, 50))
        font = QtGui.QFont()
        font.setFamily("Umpush")
        font.setPointSize(12)
        font.setBold(False)
...
"}")
        ...
        self.checkBox_save_user = QtWidgets.QCheckBox(self.login_bar)
        self.checkBox_save_user.setGeometry(QtCore.QRect(85, 420, 281, 22))
        font = QtGui.QFont()
...
"}")
        ...
        self.pushButton_login = QtWidgets.QPushButton(self.login_bar)
        self.pushButton_login.setGeometry(QtCore.QRect(85, 450, 280, 50))
...
"}")
        ...
        self.horizontalLayout.addWidget(self.login_bar)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_credits.setText(_translate("MainWindow", "Created by: Elton J. Robaina"))
